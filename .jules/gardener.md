...
## 2024-03-23 - Consolidate ID gathering before batch lookups
**Smell:** Duplicated list comprehensions for gathering IDs across nested loop structures before passing to batch retrieval methods.
